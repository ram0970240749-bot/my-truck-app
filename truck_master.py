...
if not st.session_state['logged_in']:
    ...
    def render_thai_map(data_df):
        ...
        route_layer = pdk.Layer(
            ...
            get_color=[52, 152, 219, 255], # สีฟ้าเรืองแสง
            get_width=4, 
            pickable=False
        )
    ...
    # ==========================================
    # 🚛 สิทธิ์ที่ 3: พนักงานขับรถ (Driver) -> 🛠️ [แก้ไขย่อหน้าบรรทัด 204 สำเร็จ 100%]
    # ==========================================
    elif st.session_state['user_role'] == "พนักงานขับรถ (Driver)":
        st.title("📝 ระบบรายงานสถานะสำหรับพนักงานขับรถ (สิทธิ์: พนักงานขับรถ)")
        
        # รื้อระบบแท็บออกชั่วคราวเพื่อจัดระเบียบย่อหน้าใหม่ให้เรียบง่ายและปลอดภัยที่สุด ป้องกันแอปพังซ้ำซ้อน
