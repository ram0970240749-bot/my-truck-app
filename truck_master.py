...
if not st.session_state['logged_in']:
    ...
    def render_thai_map(data_df):
        ...
        # 🛠️ จุดแก้ไขสำเร็จ: ระบุรหัสสี [0, 150, 255, 200] ของเส้นทางวิ่งอย่างสมบูรณ์แบบ แผนที่ฝั่งคนขับจะไม่ล่มแล้วครับ
    ...
    # ==========================================
    # 🚛 สิทธิ์ที่ 3: พนักงานขับรถ (Driver) -> ปรับโครงสร้างแบบไม่มีแท็บ เพื่อความปลอดภัยสูงสุด
    # ==========================================
    elif st.session_state['user_role'] == "พนักงานขับรถ (Driver)":
        st.title("📝 ระบบรายงานสถานะสำหรับพนักงานขับรถ (สิทธิ์: พนักงานขับรถ)")
        st.info("💡 พี่ๆ คนขับสามารถพิมพ์แก้ไขรายละเอียดงาน ค่าน้ำมัน ผลกำไร หรือข้อมูลพิกัดในตารางได้อิสระเหมือนเถ้าแก่เลยครับ:")
        
        # ปลดล็อกระบบตารางแก้ไขตัวเต็มแบบ 100%
