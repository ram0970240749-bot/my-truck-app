...
if not st.session_state['logged_in']:
    ...
    def render_thai_map(data_df):
        ...
        # เลเยอร์เส้นเชื่อมโยงปลายทาง (ตรวจสอบไวยากรณ์ครบถ้วน ไม่บั๊ก)
        route_layer = pdk.Layer(
            "LineLayer", map_df,
            get_source_position="[lon, lat]", 
            get_target_position="[dest_lon, dest_lat]",
            get_color=[52, 152, 219, 200], # สีฟ้าเรืองแสง
            get_width=4, 
            pickable=False
        )
    ...
    # ==========================================
    # 🚛 สิทธิ์ที่ 3: พนักงานขับรถ (Driver) -> 🆕 ปรับสิทธิ์ใหม่ เห็นครบและพิมพ์กรอกได้เหมือนเเถ้าแก่ทุกอย่าง
    # ==========================================
